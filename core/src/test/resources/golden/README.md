...
(`kp-crosscheck 0.5`) with **pyswisseph 2.10.03** and real Swiss Ephemeris data
...
node agency / ruling planets, the SPEC-004 dasha balance / running stack, and the
SPEC-005 horary case. Sanity-checked against public
...
5. **4th chart (wanted):** a KP-textbook worked example where the planet + cusp
