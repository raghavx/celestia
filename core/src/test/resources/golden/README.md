...
(`kp-crosscheck 0.4`) with **pyswisseph 2.10.03** and real Swiss Ephemeris data
...
node agency / ruling planets, and the SPEC-004 dasha balance / running stack.
Sanity-checked against public
...
4. **4th chart (wanted):** a KP-textbook worked example where the planet + cusp
