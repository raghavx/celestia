...
|---|----------|----------------|----------------|
| D1 | **Swiss Ephemeris licensing** | Decide now: comply with **AGPL-3.0** (offer source to network users) or buy the **Swiss Ephemeris Professional License** from Astrodienst. Moshier mode does **not** exempt you. | The Java port is AGPL; shapes whether Celestia can be closed-source SaaS. |
...
| Risk | Mitigation |
|------|-----------|
| Swiss Ephemeris AGPL vs closed-source SaaS | Decide D1 in Phase 0; budget for the professional license |
...
10. Gather the 3–5 golden KP charts with published values.
